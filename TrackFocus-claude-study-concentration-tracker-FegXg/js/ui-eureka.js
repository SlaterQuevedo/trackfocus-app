...
const UIEureka = (() => {
    ...
    return `
      <div class="eureka">
        <div class="eureka-hero">
          <div class="ek-badge">🏆 TrackNara · Resultados del Piloto</div>
          <h1 class="eureka-title">Impacto medible en concentración y aprendizaje</h1>
          <p class="eureka-sub">Datos reales de los estudiantes que usan TrackNara en su preparación diaria.</p>
        </div>
  ...
  async function _exportEurekaPdf() {
    ...
    const body = `
      <h1>TrackNara — Resultados del Piloto</h1>
    ...
    Exporter.printHTML('Resultados del Piloto — TrackNara', body);
  }
