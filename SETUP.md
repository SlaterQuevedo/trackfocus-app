# TrackNara — Setup de la nube (Supabase + Google OAuth)

> Nota: el proyecto se llama **TrackNara** (antes *TrackFocus*). Algunos nombres de infraestructura ya
...
1. Inicia sesión con Google en TrackNara (entrarás como estudiante)
...
3. Ejecuta (reemplaza el email):
   ...
   ```
4. Recarga TrackNara. Ahora verás el panel de administrador.
