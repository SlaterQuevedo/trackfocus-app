# Informe técnico — TrackNara: de prototipo a plataforma institucional

> Nota: el proyecto se llama **TrackNara** (antes *TrackFocus*). Los identificadores técnicos que conservan
